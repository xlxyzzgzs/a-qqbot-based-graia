...
from graia.application.entry import MemberJoinEvent,MessageChain,Plain,Member,At,Source
...
def AddMemberJoinEventListener(bcc:Broadcast)->None:
    ...
    bcc.receiver("GroupMessage",headless_decoraters=[startWith("#更新入群词")])(GroupUpdateMemberJoinMessage)
    bcc.receiver("GroupMessage",headless_decoraters=[strictPlainCommand("#当前入群词")])(GroupNowMemberJoinMessage)
