...
def GetAllFromGroupDB(
    app: GraiaMiraiApplication,
    group: Union[Group, int],
    table: str,
    paramName: str,
    param: Optional[Union[str, int]] = None,
...
def GetFromGroupInfoDB(
    app: GraiaMiraiApplication, group: Union[Group, int], paramName: str
) -> Optional[Union[str, int]]:
    """
    从 GroupInfo 中获取信息.
    """
...
def InsertNewGroupToGroupInfoDB(
    app: GraiaMiraiApplication, group: Union[Group, int]
) -> bool:
    """
    向 GroupInfo中插入新项
    """
...
def GetMemberStatusFromGrouBlockDB(
    app: GraiaMiraiApplication,
    group: Union[Group, int],
...
def InsertMemberStatusToGroupBlockDB(
    app: GraiaMiraiApplication,
    group: Union[Group, int],
    target: Union[Member, int],
    paramName: str,
...
def InsertGroupSentenceIntoDB(
    app: GraiaMiraiApplication, group: Union[Group, int], Sentence: str, SentenceID: int
) -> bool:
    if isinstance(group, Group):
        group = group.id
    conn = sqlite3.connect("GroupDB.db")
...
def GetSentenceFromDBById(
    app: GraiaMiraiApplication, group: Union[Group, int], SentenceID: int
) -> Optional[str]:
    if isinstance(group, Group):
        group = group.id
    conn = sqlite3.connect("GroupDB.db")
